========================================================================
    APLICACIÓN DE CONSOLA: Sample-Semaphore Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación Sample-Semaphore.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la Sample-Semaphore aplicación.


Sample-Semaphore.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Sample-Semaphore.pch y un archivo de 
